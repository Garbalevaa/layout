...
//Фунция закрытия всплывающегося меню "заказать звонок" при нажании на кнопку "отмена"
    ...
    // });
//Функция вызова открывающегося меню при нажатии на кнопку "узнать больше",
//"узнать стоимость", "заказать проект"

    
     //    $('.name-container__button, .my-work__button, .do-container__button').click(function () {
     //    $('body').css('overflow', 'hidden'); // Просто добавляем стиль для body
     //    $('.popup__main-container_button').fadeIn(400); 
     //    $('.main-container__button-news').animate({
     //        width: '1024px',
     //        height: '1200px'
     //    }, 400);
     ...
     // })
        ...
        //Функция вызова открывающегося меню при нажатии на кнопку "узнать больше",
//"узнать стоимость", "заказать проект для мобильной версии"

    
     //    $('.name-container__button_320, .my-work__button_320, .do-container__button_320').click(function () {
     //    $('body').css('overflow', 'hidden'); // Просто добавляем стиль для body
     //    $('.popup__main-container_button').fadeIn(400); 
     //    $('.main-container__button-news').animate({
     //        width: '100%',
     ...
     // })
//Фунция закрытия всплывающегося меню "узнать больше" при нажании на кнопку "отмена"
    // $('.btn-cancel').click(function () {
        
    //         $('body').css('overflow', 'auto'); // А тут его возвращаем в auto

    //         $('.popup__main-container_button').fadeOut(400); 
    //         $('.main-container__button-news').animate({
    //             width: '0',
    //             height: '0'
    //         }, 400);
